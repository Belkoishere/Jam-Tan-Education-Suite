...
CONSTRAINT StudentProgram UNIQUE KEY (StudentID, ProgramID),
...
CONSTRAINT AssessmentEnrollment UNIQUE KEY (AssessmentID, EnrollmentID),
...
CONSTRAINT StaffProgram UNIQUE KEY (StaffID, ProgramID),
