...
$GetPrograms->execute(['id' => $AccountID]);
...
if ($InProgram !== '') {
    ...
    JOIN Assignment ON Program.ProgramID = Assignment.ProgramID
    WHERE Program.ProgramID = :program
    AND Assignment.StaffID = :id)";
            ...
            <?php foreach ($Students as $Student): ?>
                <div class="table">
                    <div class="table-contents-container">
                        ...
                        <a href="Student.php?id=<?= $Student["StudentID"]?>&last_page=YourStudents.php"><div class="table-btn">Voir</div></a>
                    </div>
                </div>
            <?php endforeach ?>
        </div>
